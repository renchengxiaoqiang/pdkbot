...
namespace PdkBot.BotLib.Extensions
{
    public static class FileEx
    {
        ...
        {
            return GetFileLength(fn) > maxkb * 1024;
        }
        ...
        public static void TryDelete(List<string> fnlist)
        {
            ...
            {
                DeleteWithoutException(fn, null);
            }
        }
        ...
        {
            return TryReadFile(fn, Util.EncodingGb2312);
        }
        ...
        public static void ShowStringWithNotePad(string txt)
        {
            ...
            SaveToFile(tempTxtFileName, txt);
        ...
        public static bool IsTwoFileEqual(string fn1, string fn2)
        {
            ...
            int len = (int)Math.Ceiling(f1.Length / (double)seed);
