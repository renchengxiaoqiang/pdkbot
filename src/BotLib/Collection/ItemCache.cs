...
namespace PdkBot.BotLib.Collection
{
    public static class ItemCache
    {
        ...
        {
            string text;
            return GetData(producer, out text, 0, caller, path, line);
        }
        ...
        {
            string text;
            return GetData(producer, out text, timeoutMs, caller, path, line);
        }
        ...
        {
            return GetData(producer, out key, 0, caller, path, line);
        }
