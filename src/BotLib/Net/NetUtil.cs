...
namespace PdkBot.BotLib.Net
{
    public static class NetUtil
    {
        ...
        public static void DownFile(string url, string localfn, int len = 0)
        {
            ...
            if (len > 0)
            {
                Util.Assert(len == FileEx.GetFileLength(localfn), "下载文件大小出错");
            }
        }
        ...
        public static void DownFile(object patchUrl, string patchFn, object patchSize)
        {
            throw new NotImplementedException();
        }

        public static void DownFile(object patchUrl, string patchFn, int patchSize)
        {
            throw new NotImplementedException();
        }
    }
